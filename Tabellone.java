...
public class Tabellone{
    ...
    private void inizializzaTabellone(){
        ...
        tabellone[3] = new Terreno("Vicolo Stretto",tabellone[4],tabellone[3],4,60,Colore.MARRONE,null);
        ...
        tabellone[39] = new Terreno("Parco della Vittoria",tabellone[0],tabellone[38],0,400,Colore.BLU,null);
